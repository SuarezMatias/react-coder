...
const removeFromCart = (itemId) => {
  setCart((previousStateCart) => previousStateCart.filter((item) => item.id !== itemId));
};
...
return (
  <CartContext.Provider value={{cart, addToCart, removeFromCart, clearCart, getQuantity, getTotalPrice}}>
    {children}
